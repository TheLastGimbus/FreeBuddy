> # TODO: To be finished with protocol details
...
|---|---|
|  ![Image from vendor's page](https://consumer.huawei.com/dam/content/dam/huawei-cbg-site/common/mkt/pdp/audio/freebuds4i/img2/huawei-freebuds-4i-kv1.png) | ![Image from app assets](../../../../assets/app_icons/ic_launcher.png) |


# 🔎 Discoverability

Current best is to match them by bluetooth name=="HUAWEI FreeBuds 4i"

(They also have some magic bluetooth classic UUIDs, but that's to yet be researched)
...
This can be disabled through app


# 🧑‍💻 Credits

- Documentation: @TheLastGimbus
- Reverse-engineering: @TheLastGimbus, @melianmiko
- Code implementation: @TheLastGimbus
- Code maintenance: @TheLastGimbus

# 🔗 Other apps and resources

- https://github.com/melianmiko/OpenFreebuds
